  ...
  public async run(client: Lavamusic, ctx: Context, args: string[]): Promise<void> {
    ...
    if (!args[0]) {
      ...
      const helpEmbed = embed
        ...
        .setTitle('Help Menu')
        .setDescription(
          `Hey there! I'm ${this.client.user.username}, a music bot made with [YuiMusic](https://github.com/lrmn7/yuimusic) and Discord.js. You can use \`${prefix}help <command>\` to get more info on a command.`,
        )
        .setFooter({
